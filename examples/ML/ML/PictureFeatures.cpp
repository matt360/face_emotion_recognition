...
void PictureFeatures::CalculateEmotionWeightings()
{
    ...
    */
    ...
    for (int i = 0; i < left_eyebrow.size(); i++)
    {
        // (5 - 6)
        // at the beginning we don't have to adjust for vector size difference
        picture_weightings.push_back(left_eyebrow.at(i) - left_eye.at(i + 1));
        pictureWeightingsFile << left_eyebrow.at(i) - left_eye.at(i + 1) << std::endl;
    }
    ...
    {
        // (5 - 6)
        picture_weightings.push_back(right_eyebrow.at(i) - right_eye.at(i + 1));
        pictureWeightingsFile << right_eyebrow.at(i) - right_eye.at(i + 1) << std::endl;
    }
    ...
    {
        // (12 - 12)
        picture_weightings.push_back(top_lip.at(i) - bottom_lip.at(i));
        pictureWeightingsFile << top_lip.at(i) - bottom_lip.at(i) << std::endl;
    }
    ...
    {
        // (5 - 4)
        picture_weightings.push_back(nose_bridge.at(i) - nose_tip.at(i + 1));
        pictureWeightingsFile << nose_bridge.at(i) - nose_tip.at(i + 1) << std::endl;
    }
